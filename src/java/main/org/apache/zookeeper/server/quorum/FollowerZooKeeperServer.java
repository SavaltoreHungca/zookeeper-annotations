...
public class FollowerZooKeeperServer extends LearnerZooKeeperServer {
    ...
    SyncRequestProcessor syncProcessor; // 同步请求处理器

    /*
     * Pending sync requests
     */
    ConcurrentLinkedQueue<Request> pendingSyncs; // 待同步请求
    ...
    LinkedBlockingQueue<Request> pendingTxns = new LinkedBlockingQueue<Request>(); // 待处理的事务请求
    ...
    public void logRequest(TxnHeader hdr, Record txn) {
        ...
        if ((request.zxid & 0xffffffffL) != 0) { // zxid后32位不为0，表示本服务器已经处理过请求
