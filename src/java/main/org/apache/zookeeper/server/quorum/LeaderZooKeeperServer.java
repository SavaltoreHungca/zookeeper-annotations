 ...
 *
 * 请求处理链为PrepRequestProcessor -> ProposalRequestProcessor -> CommitProcessor -> Leader.ToBeAppliedRequestProcessor -> FinalRequestProcessor
 */
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    /**
     * 其直接调用父类QuorumZooKeeperServer的构造函数，然后再调用ZooKeeperServer的构造函数，逐级构造
     * @param port
     * @param dataDir
     * @throws IOException
     */
    ...
    /**
     * 该函数用于注册JMX服务，首先使用DataTree初始化DataTreeBean，
     * 然后使用DataTreeBean和ServerBean调用register函数进行注册
     */
    @Override
